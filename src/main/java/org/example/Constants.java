...
public class Constants {
    ...
    public static final List<String> isMessageTechJudgeList =  Arrays.asList("物联网","云计算","人工智能","区块链","信息","软件","信息安全","网络工程","网络安全","智能");

    public static final List<String> isDataPracticeJudgeList = Arrays.asList("互联网","金融","电信","医疗","电子","自动化","自动控制","大数据","数字媒体","数字经济","电子商务","地理信息");
